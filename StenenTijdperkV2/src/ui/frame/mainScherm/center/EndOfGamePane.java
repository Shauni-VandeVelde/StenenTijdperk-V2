...
public class EndOfGamePane extends RightPaneBlueprint
{
    ...
    private HBox getNamenPaneel(int aantal)
    {
        ...
        DeelPaneel spelerDeelPaneel = new DeelPaneel(0.15, 0.14, vbox, true);
        DeelPaneel huttenPuntenDeelPaneel = new DeelPaneel(widthDiv, 0.14, vbox, true);
        DeelPaneel grondstoffenPuntenDeelPaneel = new DeelPaneel(widthDiv, 0.14, vbox, true);
        DeelPaneel totaalPuntenDeelPaneel = new DeelPaneel(widthDiv, 0.14, vbox, true);
